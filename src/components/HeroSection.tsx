...
export default function HeroSection() {
  ...
  return (
    <section 
      className="relative min-h-screen bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 py-20 md:py-32 flex items-center overflow-hidden"
      style={{
        backgroundImage: `linear-gradient(rgba(59, 130, 246, 0.7), rgba(37, 99, 235, 0.8)), url(${heroImage})`,
    ...
    >
      ...
      <div className="absolute top-20 left-10 w-12 h-12 bg-yellow-300/20 rounded-full animate-pulse"></div>
      <div className="absolute bottom-32 right-16 w-10 h-10 bg-blue-300/30 rounded-full animate-pulse delay-1000"></div>
      <div className="absolute top-1/3 right-20 w-8 h-8 bg-white/20 rounded-full animate-pulse delay-500"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 w-full relative z-10">
        <div className="text-center mb-16">
          <div className="bg-white/15 backdrop-blur-md rounded-3xl p-8 md:p-16 shadow-2xl border border-white/20 max-w-5xl mx-auto relative">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-tight">
              Find Your Perfect
              <span className="bg-gradient-to-r from-yellow-300 to-yellow-400 bg-clip-text text-transparent block mt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button 
                ...
                size="lg" 
                className="text-lg px-12 py-8 shadow-xl bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-gray-900 font-bold transform hover:scale-105 transition-all duration-300 rounded-full"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6 bg-white/15 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
            <div className="bg-blue-600/90 p-3 rounded-2xl w-fit mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
