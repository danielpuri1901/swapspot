      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Students Love Our 
            <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent"> AI Matching</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-white p-6 rounded-2xl relative shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
              <div className="absolute -top-3 -right-3 w-6 h-6 bg-blue-600 rounded-full opacity-80 group-hover:scale-125 transition-transform duration-300"></div>
        ...
        <div className="text-center">
          <div className="bg-blue-600 rounded-2xl p-6 text-white max-w-3xl mx-auto shadow-xl">
            <GraduationCap className="h-8 w-8 mx-auto mb-3 text-blue-200" />
